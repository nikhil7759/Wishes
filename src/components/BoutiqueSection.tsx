    ...
    >
      ...
      >
        ...
        <div className="space-y-4 font-jost font-light text-[15px] md:text-[16px] leading-relaxed text-[#fbede3] py-2">
          <p>
            Wishes invites you to step inside our boutique and experience the magic of luxury gifting first-hand. Our boutique is a sensory haven featuring a beautifully curated collection of premium sweets, artisanal chocolates, savoury delights, custom-crafted hampers, and exclusive wedding & trousseau collections.
          </p>
