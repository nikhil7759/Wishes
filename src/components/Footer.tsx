...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#c8c8ae] py-16 px-6 md:px-16 lg:px-24 select-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 lg:gap-12 items-start">
          ...
          <div className="md:col-span-5 flex flex-col items-start text-left">
            ...
            <p className="font-jost font-light text-[14px] md:text-[15px] leading-relaxed text-black max-w-md">
              Indulge in luxury with every bite at WishesIndia, where tradition meets exquisite taste. Our handcrafted sweets are made with the finest ingredients, perfect for every occasion. Whether it is a special celebration or a sweet treat for yourself, we bring you the best of luxury in every bite. Experience the sweetness of life, redefined.
            </p>
